...
public class LayerCrudServiceTest
{
  ...
  public void setUp()
  {
    ...
    Assume.assumeTrue("This test needs a running test-framework!", WskFramework.isRunning());
    
    bbox = WskServiceProvider.getInstance().getBboxService()
    ...
    DataStore store = WskFramework.getInstance().getWskGeoPackage().getDataStore();
  ...
  private LayerModel assertThatLayerIsCreatedWithExpectedContent(String name)
  {
    ...
    WmsConfig wmsConfig = WskTestFactory.createWmsConfig();
